...
uint Clk_SdCard::countCharInFile(const char *fileFullName, char charToCount) {
  uint charCount = 0;
...
uint Clk_SdCard::countLinesInFile(const char *fileFullName) {
...
bool Clk_SdCard::saveConfig(const char *fileFullName) {
...
void Clk_SdCard::writeLogEntry(const char *fileFullName, const char *message, const char *errorlevel) {
